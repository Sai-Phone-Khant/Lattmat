                  ...
                  <div className="p-6 space-y-4">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                      <div>
                        ...
                        <p className="text-gray-600">2024.01.02 (Monday)</p>
                      </div>
                      <div>
                  ...
                  <div className="p-6 space-y-6">
                    ...
                    <div className="space-y-4">
                      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between">
                        ...
                        <span className="text-blue-700">123456</span>
                      </div>
                      
                      <div className="grid grid-cols-3 gap-4 text-center">
                        <div>
                          <h4 className="text-gray-800 mb-1">Zone</h4>
                          <p className="text-gray-600">{ticketData.vipQuantity > 0 ? 'VIP' : 'GA'}</p>
                        </div>
                        <div>
                          <h4 className="text-gray-800 mb-1">Role</h4>
                          <p className="text-gray-600">A</p>
                        </div>
                        <div>
                          <h4 className="text-gray-800 mb-1">Seat</h4>
                      ...
                      {/* Ticket 2 (if multiple tickets) */}
                      {(ticketData.gaQuantity + ticketData.vipQuantity) > 1 && (
                        <>
                          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between">
                            <span className="text-gray-800 mb-1 sm:mb-0">Ticket ID</span>
                            <span className="text-blue-700">123457</span>
                          </div>
                          ...
                          <div className="grid grid-cols-3 gap-4 text-center">
                            ...
                            <div>
                              <h4 className="text-gray-800 mb-1">Seat</h4>
                              <p className="text-gray-600">002</p>
                            </div>
                          </div>
