    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
      <div className="bg-white rounded-lg max-w-2xl w-full max-h-[90vh] overflow-y-auto">
        <div className="relative">
          ...
          <div className="p-6">
            <h2 className="text-2xl text-gray-800 mb-4">{event.title}</h2>
            
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
              <div>
                <h3 className="text-gray-700 mb-2">Date & Time</h3>
            ...
            <div className="mb-6">
              <h3 className="text-gray-700 mb-2">About this Event</h3>
            ...
            <div className="border-t pt-4">
              <div className="flex items-center justify-between">
                <div>
                  <h3 className="text-gray-700">Starting from</h3>
                  <p className="text-2xl text-blue-600">{event.price}</p>
                </div>
