                  ...
                  <div className="p-4 sm:p-6">
                    ...
                    <div className="flex justify-between items-center mb-4 sm:mb-5">
                      <span className="text-gray-600 text-base sm:text-lg">
                        {ticketData.vipQuantity > 0 ? 'VIP' : 'GA'}
                      </span>
                    ...
                    <div className="space-y-3 sm:space-y-5">
                      <div className="flex justify-between items-start">
                        ...
                        <span className="text-gray-600 text-base sm:text-lg text-right">2024.01.02( Monday)</span>
                      </div>
                      
                      <div className="flex justify-between items-start">
                        <span className="text-gray-800 text-base sm:text-lg">Event Place</span>
                        <span className="text-gray-600 text-base sm:text-lg text-right">{event.venue}</span>
                      </div>
                      
                      <div className="flex justify-between items-start">
                        <span className="text-gray-800 text-base sm:text-lg">Event City</span>
                        <span className="text-gray-600 text-base sm:text-lg text-right">{event.location.split(',')[0]}</span>
                      </div>
                      ...
                      <div className="flex justify-between items-center">
                        ...
                        <span className="text-gray-600 text-base sm:text-lg">{ticketData.gaQuantity + ticketData.vipQuantity}</span>
                      </div>
                      ...
                      <div className="space-y-2 sm:space-y-2.5">
                        <div className="flex justify-between items-center">
                          ...
                          <span className="text-gray-600 text-base sm:text-lg">Ks {subtotal.toLocaleString()}</span>
                        </div>
                        
                        <div className="flex justify-between items-center">
                          <span className="text-gray-800 text-base sm:text-lg">Service Charges ( 10 % )</span>
                          <span className="text-gray-600 text-base sm:text-lg">Ks {serviceCharge.toLocaleString()}</span>
                        </div>
                        
                        <div className="flex justify-between items-center">
                          <span className="text-gray-800 text-base sm:text-lg">Tax ( 5 % )</span>
                          <span className="text-gray-600 text-base sm:text-lg">Ks {tax.toLocaleString()}</span>
                        </div>
                        ...
                        <div className="flex justify-between items-center pt-2 sm:pt-2.5 border-t border-gray-200">
                          ...
                          <span className="text-blue-700 text-lg sm:text-xl lg:text-2xl">Ks {total.toLocaleString()}</span>
                        </div>
                      </div>
                    </div>
                  </div>
