import svgPaths from "./svg-pi8a8sn9sz";
import imgLattmat2 from "figma:asset/368080d9df66133b0a78eb531bbeff0043586346.png";
import imgRectangle116 from "figma:asset/e14317c8df1911bbf9731f28d5054841ba42d550.png";
import imgRectangle117 from "figma:asset/7f12ea1300756f144a0fb5daaf68dbfc01103a46.png";
...
function Back() {
  return (
    <div
      className="[grid-area:1_/_1] box-border content-stretch flex flex-row gap-5 items-center justify-start ml-0 mt-0 p-0 relative w-[1298.11px]"
      data-name="back"
    >
...
function Header1() {
  return (
    <div
      className="bg-[#ebebeb] box-border content-stretch flex flex-row gap-2.5 h-[43px] items-center justify-center p-0 relative rounded-tl-[5px] rounded-tr-[5px] shrink-0 w-full"
      data-name="header"
    >
      <div
        className="flex flex-col font-['Roboto:SemiBold',_sans-serif] font-semibold justify-center leading-[0] relative shrink-0 text-[#455358] text-[20px] text-center text-nowrap"
        style={{ fontVariationSettings: "'wdth' 100" }}
      >
  ...
  return (
    ...
    >
      <div className="flex flex-row items-end relative size-full">
        <div className="box-border content-stretch flex flex-row gap-5 items-end justify-start leading-[0] px-[30px] py-0 relative text-[18px] w-full">
          <div
            className="flex flex-col font-['Roboto:Bold',_sans-serif] font-bold justify-center relative shrink-0 text-[#333333] text-left w-[134px]"
            style={{ fontVariationSettings: "'wdth' 100" }}
          >
            <p className="block leading-[24px]">Order ID</p>
          </div>
          <div
            className="flex flex-col font-['Roboto:Medium',_sans-serif] font-medium justify-center relative shrink-0 text-[#455358] text-nowrap text-right"
            style={{ fontVariationSettings: "'wdth' 100" }}
          >
            <p className="block leading-[24px] whitespace-pre">1124557TT</p>
          </div>
        </div>
      </div>
    </div>
...
function Warp2() {
  return (
    <div
      className="box-border content-stretch flex flex-row gap-5 items-center justify-start leading-[0] p-0 relative shrink-0 text-[18px] text-nowrap"
      data-name="warp"
    >
      <div
        className="flex flex-col font-['Roboto:Bold',_sans-serif] font-bold justify-center relative shrink-0 text-[#333333] text-left"
        style={{ fontVariationSettings: "'wdth' 100" }}
      >
      ...
      <div
        className="flex flex-col font-['Roboto:Medium',_sans-serif] font-medium justify-center relative shrink-0 text-[#455358] text-right"
        style={{ fontVariationSettings: "'wdth' 100" }}
      >
        <p className="block leading-[24px] text-nowrap whitespace-pre">
          2023.12.16
...
function Warp3() {
  return (
    <div
      className="box-border content-stretch flex flex-row gap-5 items-center justify-start leading-[0] p-0 relative shrink-0 text-[18px] text-nowrap w-[316px]"
      data-name="warp"
    >
      <div
        className="flex flex-col font-['Roboto:Bold',_sans-serif] font-bold justify-center relative shrink-0 text-[#333333] text-left"
        style={{ fontVariationSettings: "'wdth' 100" }}
      >
        <p className="block leading-[24px] text-nowrap whitespace-pre">{`Purchasing  Time`}</p>
      </div>
      <div
        className="flex flex-col font-['Roboto:Medium',_sans-serif] font-medium justify-center relative shrink-0 text-[#455358] text-right"
        style={{ fontVariationSettings: "'wdth' 100" }}
  ...
  return (
    <div className="relative shrink-0 w-full">
      <div className="relative size-full">
        <div className="box-border content-stretch flex flex-row items-start justify-between px-[30px] py-0 relative w-full">
          <Warp2 />
          <Warp3 />
        </div>
      </div>
...
function Warp5() {
  return (
    <div
      className="box-border content-stretch flex flex-row gap-5 items-center justify-start leading-[0] p-0 relative shrink-0 text-[18px] w-[316px]"
      data-name="warp"
    >
      <div
        className="flex flex-col font-['Roboto:Bold',_sans-serif] font-bold justify-center relative shrink-0 text-[#333333] text-left w-[142px]"
        style={{ fontVariationSettings: "'wdth' 100" }}
      >
        <p className="block leading-[24px]">Total Amount</p>
      </div>
      <div
        className="flex flex-col font-['Roboto:Medium',_sans-serif] font-medium justify-center relative shrink-0 text-[#455358] text-nowrap text-right"
        style={{ fontVariationSettings: "'wdth' 100" }}
      >
        <p className="block leading-[24px] whitespace-pre">115,000 Ks</p>
      </div>
    </div>
  );
}
...
function Header3() {
  return (
    <div className="bg-[#ebebeb] relative shrink-0 w-full" data-name="header">
...
function Warp6() {
  return (
    <div className="relative shrink-0 w-full" data-name="warp">
      <div className="flex flex-row items-center relative size-full">
        <div className="box-border content-stretch flex flex-row font-['Roboto:Bold',_sans-serif] font-bold items-center justify-between leading-[0] px-[30px] py-0 relative text-[#333333] text-[18px] text-left w-full">
          <div
            className="basis-0 flex flex-col grow justify-center min-h-px min-w-px relative shrink-0"
            style={{ fontVariationSettings: "'wdth' 100" }}
          >
            <p className="block leading-[24px]">Customer Name</p>
          </div>
          <div
            className="basis-0 flex flex-col grow justify-center min-h-px min-w-px relative shrink-0"
            style={{ fontVariationSettings: "'wdth' 100" }}
          ...
          <div
            className="flex flex-col justify-center relative shrink-0 w-[316px]"
            style={{ fontVariationSettings: "'wdth' 100" }}
          >
...
function Warp7() {
  return (
    <div className="relative shrink-0 w-full" data-name="warp">
      <div className="flex flex-row items-center relative size-full">
        <div className="box-border content-stretch flex flex-row font-['Roboto:Medium',_sans-serif] font-medium items-center justify-between leading-[0] px-[30px] py-0 relative text-[#455358] text-[18px] text-left w-full">
          <div
            className="basis-0 flex flex-col grow justify-center min-h-px min-w-px relative shrink-0"
            style={{ fontVariationSettings: "'wdth' 100" }}
          >
            <p className="block leading-[24px]">Daniel Khant</p>
          </div>
          <div
            className="basis-0 flex flex-col grow justify-center min-h-px min-w-px relative shrink-0"
            style={{ fontVariationSettings: "'wdth' 100" }}
          >
            <p className="block leading-[24px]">09 420148498</p>
          </div>
          <div
            className="flex flex-col justify-center relative shrink-0 w-[316px]"
            style={{ fontVariationSettings: "'wdth' 100" }}
          >
            <p className="block leading-[24px]">phonekhant156@gmail.com</p>
          </div>
        </div>
      </div>
    </div>
...
function Warp8() {
  return (
    <div className="relative shrink-0 w-full" data-name="warp">
      <div className="flex flex-row items-end relative size-full">
        <div className="box-border content-stretch flex flex-row gap-5 items-end justify-start leading-[0] px-[30px] py-0 relative text-[18px] text-nowrap w-full">
          <div
            className="flex flex-col font-['Roboto:Bold',_sans-serif] font-bold justify-center relative shrink-0 text-[#333333] text-left"
            style={{ fontVariationSettings: "'wdth' 100" }}
          >
          ...
          <div
            className="flex flex-col font-['Roboto:Medium',_sans-serif] font-medium justify-center relative shrink-0 text-[#0715c9] text-right"
            style={{ fontVariationSettings: "'wdth' 100" }}
          >
            <p className="block leading-[24px] text-nowrap whitespace-pre">
              Waterzonic Festival
      ...
      <div className="flex flex-row items-center relative size-full">
        <div className="box-border content-stretch flex flex-row font-['Roboto:Bold',_sans-serif] font-bold items-center justify-between leading-[0] px-[30px] py-0 relative text-[#333333] text-[18px] text-left w-full">
          ...
          <div
            ...
            style={{ fontVariationSettings: "'wdth' 100" }}
          >
            <p className="block leading-[24px]">Event Time</p>
          </div>
          <div
            className="flex flex-col justify-center relative shrink-0 w-[316px]"
            style={{ fontVariationSettings: "'wdth' 100" }}
      ...
      <div className="flex flex-row items-center relative size-full">
        <div className="box-border content-stretch flex flex-row font-['Roboto:Medium',_sans-serif] font-medium items-center justify-between leading-[0] px-[30px] py-0 relative text-[#455358] text-[18px] text-left w-full">
          ...
          <div
            ...
            style={{ fontVariationSettings: "'wdth' 100" }}
          >
            <p className="block leading-[24px]">6 : 00 PM</p>
          </div>
          <div
            className="flex flex-col justify-center relative shrink-0 w-[316px]"
            style={{ fontVariationSettings: "'wdth' 100" }}
          >
            <p className="block leading-[24px]">Thuwanabumi Event Park</p>
          </div>
        </div>
      </div>
    </div>
...
function Body() {
  return (
    <div
      className="bg-[#ffffff] box-border content-stretch flex flex-col gap-5 items-start justify-start px-0 py-5 relative rounded-bl-[5px] rounded-br-[5px] shrink-0 w-full"
      data-name="body"
    >
      <Frame1904 />
      <Frame1888 />
...
function PurchasingInformation() {
  return (
    <div
      className="basis-0 box-border content-stretch flex flex-col gap-5 grow items-start justify-start min-h-px min-w-px p-0 relative shadow-[0px_1px_4px_0px_rgba(51,51,51,0.3)] shrink-0"
      data-name="Purchasing Information"
    >
      <Card />
    </div>
  );
...
function Header5() {
  return (
    <div
      className="bg-[#0715c9] box-border content-stretch flex flex-row gap-2.5 h-16 items-center justify-center p-0 relative rounded-tl-[5px] rounded-tr-[5px] shrink-0 w-full"
      data-name="header"
    >
      <div
        ...
        style={{ fontVariationSettings: "'wdth' 100" }}
      >
        <p className="block leading-[30px] whitespace-pre">Your Tickets</p>
      </div>
    </div>
  );
}
...
function Warp11() {
  return (
    <div
      className="box-border content-stretch flex flex-row gap-5 items-end justify-start leading-[0] p-0 relative shrink-0 text-[18px] text-nowrap w-full"
      data-name="warp"
    >
      <div
        className="flex flex-col font-['Roboto:Bold',_sans-serif] font-bold justify-center relative shrink-0 text-[#333333] text-left"
...
function Warp12() {
  return (
    <div
      className="box-border content-stretch flex flex-row font-['Roboto:Bold',_sans-serif] font-bold items-end justify-between leading-[0] p-0 relative shrink-0 text-[#333333] text-[18px] text-nowrap w-full"
      data-name="warp"
    >
      <div
        className="flex flex-col justify-center relative shrink-0 text-left"
        style={{ fontVariationSettings: "'wdth' 100" }}
      >
        <p className="block leading-[24px] text-nowrap whitespace-pre">Zone</p>
      </div>
      <div
        className="flex flex-col justify-center relative shrink-0 text-left"
        style={{ fontVariationSettings: "'wdth' 100" }}
      >
        <p className="block leading-[24px] text-nowrap whitespace-pre">Role</p>
      </div>
      <div
        className="flex flex-col justify-center relative shrink-0 text-right"
        style={{ fontVariationSettings: "'wdth' 100" }}
      >
        <p className="block leading-[24px] text-nowrap whitespace-pre">Seat</p>
      </div>
    </div>
  );
}
...
function Warp13() {
  return (
    ...
    >
      ...
      <div
        className="basis-0 flex flex-col grow justify-center min-h-px min-w-px relative shrink-0 text-center"
        style={{ fontVariationSettings: "'wdth' 100" }}
      >
...
function Export1() {
  return (
    <div className="absolute left-0 size-6 top-0" data-name="export">
      <svg
        className="block size-full"
        fill="none"
        preserveAspectRatio="none"
...
function VuesaxOutlineExport2() {
  return (
    <div
      className="absolute contents left-0 top-0"
      data-name="vuesax/outline/export"
    >
      <Export1 />
    </div>
  );
...
function VuesaxOutlineExport3() {
  return (
    <div className="relative shrink-0 size-6" data-name="vuesax/outline/export">
...
function Btn() {
  return (
    <div
      className="bg-[#ffffff] box-border content-stretch flex flex-row gap-3 h-12 items-center justify-start px-3 py-0 relative rounded-[5px] shrink-0"
      data-name="btn"
    >
      <div className="absolute border-2 border-[#0715c9] border-solid inset-0 pointer-events-none rounded-[5px]" />
      <VuesaxOutlineExport3 />
    </div>
  );
}
...
function ScanBarcode() {
  return (
    <div className="absolute left-0 size-6 top-0" data-name="scan-barcode">
      <svg
        className="block size-full"
        fill="none"
        preserveAspectRatio="none"
      ...
      >
        <g id="scan-barcode">
          ...
          />
          <path
            d={svgPaths.p28fab780}
            fill="var(--fill-0, white)"
            id="Vector_3"
          />
          <path
            d={svgPaths.p28713900}
            fill="var(--fill-0, white)"
            id="Vector_4"
          />
          <path
...
function VuesaxOutlineScanBarcode() {
  return (
    <div
      className="absolute contents left-0 top-0"
      data-name="vuesax/outline/scan-barcode"
    >
      <ScanBarcode />
    </div>
  );
...
function VuesaxOutlineScanBarcode1() {
  return (
    <div
      className="relative shrink-0 size-6"
      data-name="vuesax/outline/scan-barcode"
    >
      <VuesaxOutlineScanBarcode />
    </div>
  );
}
...
function Btn1() {
  return (
    <div
      className="bg-[#0715c9] box-border content-stretch flex flex-row gap-3 h-12 items-center justify-start px-3 py-0 relative rounded-[5px] shrink-0"
      data-name="btn"
    >
      <VuesaxOutlineScanBarcode1 />
    </div>
  );
}
...
function Btn2() {
  return (
    <div
      className="basis-0 bg-[#0715c9] grow h-12 min-h-px min-w-px relative rounded-[5px] shrink-0"
      data-name="btn"
    >
      <div className="flex flex-row items-center relative size-full">
        <div className="box-border content-stretch flex flex-row gap-3 h-12 items-center justify-start px-3 py-0 relative w-full">
          <div
            className="basis-0 flex flex-col font-['Roboto:Bold',_sans-serif] font-bold grow h-6 justify-center leading-[0] min-h-px min-w-px relative shrink-0 text-[#ffffff] text-[18px] text-center"
            style={{ fontVariationSettings: "'wdth' 100" }}
          >
            <p className="block leading-[24px]">Download</p>
          </div>
        </div>
      </div>
    </div>
  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{ fontVariationSettings: "'wdth' 100" }}
      >
        <p className="block leading-[24px]">002</p>
      </div>
    </div>
  );
}
...
function Body1() {
  return (
    <div
      className="bg-[#ffffff] relative rounded-bl-[5px] rounded-br-[5px] shrink-0 w-full"
      data-name="body"
    >
      <div className="relative size-full">
        <div className="box-border content-stretch flex flex-col gap-5 items-start justify-start px-[30px] py-5 relative w-full">
          <div
            className="bg-center bg-cover bg-no-repeat h-[159px] shrink-0 w-full"
            style={{
              backgroundImage: `url('${imgRectangle116}'), url('${imgRectangle117}')`,
            }}
          />
          <Warp11 />
          <Warp12 />
...
function Card1() {
  return (
    <div
      className="box-border content-stretch flex flex-col items-start justify-start p-0 relative shrink-0 w-[425px]"
      data-name="card"
    >
      <Header5 />
      <Body1 />
...
function TicketInformation() {
  return (
    <div
      className="box-border content-stretch flex flex-row gap-[60px] items-start justify-center p-0 relative shrink-0 w-[1292.17px]"
      data-name="ticket information"
    >
  ...
  return (
    <div className="relative shrink-0 w-full" data-name="body">
      <div className="flex flex-col items-center relative size-full">
        <div className="box-border content-stretch flex flex-col gap-5 items-center justify-start px-[200px] py-0 relative w-full">
          <Group95 />
          <TicketInformation />
        </div>
      </div>
